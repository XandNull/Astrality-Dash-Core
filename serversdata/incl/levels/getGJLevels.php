...
if($type==3){ //TRENDING
	...
	$params[] = "uploadDate > $uploadDate AND NOT originalReup > 0";
	$order = "likes";
}
...
if($type==6 OR $type==17){ //featured
	$params[] = "NOT starFeatured = 0 AND NOT originalReup > 0";
	$order = "rateDate DESC,uploadDate";
}
if($type==16){ //HALL OF FAME
	$params[] = "NOT starEpic = 0 AND NOT originalReup > 0";
	$order = "rateDate DESC,uploadDate";
}
if($type==7){ //MAGIC
	$params[] = "NOT top = '0' AND NOT originalReup > 0";
	$order = "top,uploadDate";
}
...
if($type==11){ //AWARDED
	$params[] = "NOT gp = '0' AND NOT originalReup > 0";
	$order = "gp,uploadDate";
}
if($type==12){ //FOLLOWED
	$params[] = "originalReup > 0";
}
if($type==13){ //FRIENDS
	$params[] = "NOT originalReup > 0";
	$params[] = "legendary = 1";
