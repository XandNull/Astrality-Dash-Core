...
$gs = new mainLib();
$ep = new exploitPatch();
if (empty($_POST["gjp"]) OR empty($_POST["accountID"]) OR !is_numeric($_POST["accountID"]) OR empty($_POST["levelID"]) OR !is_numeric($_POST["levelID"]) OR empty($_POST["rating"]) OR !is_numeric($_POST["rating"])) {
	exit("-1");
}
